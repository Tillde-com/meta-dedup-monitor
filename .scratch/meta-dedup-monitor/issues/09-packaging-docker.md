...
- [x] (satisfied on compressed size — Enrico, 2026-08-26; see Comments) `docker build` succeeds; final image < 100MB (`docker images` evidence in PR); `whoami` in container is non-root; no `python3`/`make`/`g++` in the final image.
